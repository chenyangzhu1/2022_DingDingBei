...
np.savetxt("决策树-results.csv", res, delimiter=',', header='precision,recall,f1-score,auc-value,time')
np.savetxt("决策树-AUC-fpr.csv", fpr, delimiter=',')
np.savetxt("决策树-AUC-tpr.csv", tpr, delimiter=',')
