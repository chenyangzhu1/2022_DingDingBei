...
model=svm.SVC(random_state=1,max_iter=100)
...
np.savetxt("SVM-results.csv", res, delimiter=',', header='precision,recall,f1-score,auc-value,time')
np.savetxt("SVM-AUC-fpr.csv", fpr, delimiter=',')
np.savetxt("SVM-AUC-tpr.csv", tpr, delimiter=',')
