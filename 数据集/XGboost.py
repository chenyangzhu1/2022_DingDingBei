...
np.savetxt("XGBoost-results.csv", res, delimiter=',', header='precision,recall,f1-score,auc-value,time')
np.savetxt("XGBoost-AUC-fpr.csv", fpr, delimiter=',')
np.savetxt("XGBoost-AUC-tpr.csv", tpr, delimiter=',')
