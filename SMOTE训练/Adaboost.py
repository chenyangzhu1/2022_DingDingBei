...
np.savetxt("Adaboost-results.csv", res, delimiter=',', header='precision,recall,f1-score,auc-value,time')
np.savetxt("Adaboost-AUC-fpr.csv", fpr, delimiter=',')
np.savetxt("Adaboost-AUC-tpr.csv", tpr, delimiter=',')
