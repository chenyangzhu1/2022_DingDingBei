...
np.savetxt("BP-results.csv", res, delimiter=',', header='precision,recall,f1-score,auc-value,time')
np.savetxt("BP-AUC-fpr.csv", fpr, delimiter=',')
np.savetxt("BP-AUC-tpr.csv", tpr, delimiter=',')
